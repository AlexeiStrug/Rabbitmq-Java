package com.example.reabbtmqproducertwo.config;
...
public class RabbitmqSchemaConfig {
    ...
    /**
     * @Bean public FanoutExchange createFanoutExchange() {
    ...
    public Declarables createRabbitmqSchema() {
        return new Declarables(new FanoutExchange("x.another-dummy", true, false, null),
                new Queue("q.another-dummy"), new Binding("q.another-dummy", Binding.DestinationType.QUEUE, "x.another-dummy", "", null));
    }
}
